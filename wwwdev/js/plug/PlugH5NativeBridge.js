(function(w, pg) {
	...
	if(w.plus) {
		...
		document.addEventListener("plusready", _plusFn, false);
	}
...
(function(w) {
	 ...
	 */
	pgn.StartDevicePlay = function(deviceid, way, way1, devName, online, cid, password, sf, ff) {
		typeof way === 'undefined' && (way = 0);
		typeof way1 === 'undefined' && (way1 = 1);
		return pg.asyncExec(N, 'StartDevicePlay', [deviceid, way, way1, devName, online, cid, password], sf, ff);
	};
